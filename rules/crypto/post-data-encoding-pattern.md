...
non-organic branch'і за §3.6), мають проходити через єдиний патерн
кодування проєкту (зазвичай AES + Base64 URL-safe, але точний
алгоритм не важливий — важливо що **один і той самий патерн**
...
[crypto/post-data-encoding-pattern] SUSPICIOUS
  ...
  Attribution-POST надсилає <plain-text body | дані з різними патернами кодування у різних викликах>.
